...
infilename1 = root_dir + r"\get_sheng_ryzz_qyzz\山西_省平台ryzz_贺家斌_20200805_162517.xlsx"
ryzz_datalist = read_excel(infilename1)
print(ryzz_datalist)
print(ryzz_datalist[0][1])
print(ryzz_datalist[0][1][1])
print(ryzz_datalist[0][1][1][6]) #zzdj
...
columnRows = ["sheng","shi","href", "entname","name", "zsbh","zzdj","zhuanye","ryzzcode"]
outfilename_gd_qyzz = root_dir + r"\get_sheng_ryzz_qyzz\山西_省平台ryzzwithzzcode_贺家斌_"
