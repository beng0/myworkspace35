...
class  JstQyyjPage(BasePage):
    ...
    # 山西省
    shanxi_loc=(By.XPATH,'//*[@id="div_province"]/a[15]')

    #所有的区
    sz_all_qu_xpath='//*[@id="div_area"]/a'
    ...
    #           /div[2]/div[2]/dl/dd[1]/a/strong
    zbsl_text='./div[2]/div[2]/dl/dd[1]/a/strong/text()'
    ...
    def  goto_yema2(self,yema):        #/html/body/div[8]/div[2]/div[2]/div/div/div/input[1]
